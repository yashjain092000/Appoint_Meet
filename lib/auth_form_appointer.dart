                ...
                children: <Widget>[
                  ...
                  if (!_isLogin)
                    TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Consultation Fee'),
                      onSaved: (value) {
                        _fee = value;
                      },
                    ),
                  if (!_isLogin)
                    TextFormField(
                      ...
                      decoration: InputDecoration(labelText: 'Emergency Fee'),
                      onSaved: (value) {
                        _emFee = value;
                      },
                    ),
                  ...
                  if (!_isLogin)
                    TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Evening starting time'),
                      onSaved: (value) {
                  ...
                  if (!_isLogin)
                    TextFormField(
                      ...
                      decoration:
                          InputDecoration(labelText: 'Evening ending time'),
                      onSaved: (value) {
